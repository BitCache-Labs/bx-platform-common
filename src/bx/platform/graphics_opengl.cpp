...
GraphicsHandle GraphicsOpenGL::CreateTexture(const TextureInfo& info)
{
...
GraphicsHandle GraphicsOpenGL::CreateBuffer(const BufferInfo& info)
{
    GLenum target = 0;
    GLenum usage = 0;
